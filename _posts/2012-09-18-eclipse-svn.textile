...
h3. 我使用的是 Subclipse + SVNKit，下面具体讲解一下配置过程
...
在 SVNKit "官网下载":http://svnkit.com/download.php 上查找相应的 Eclipse 更新网站地址，我使用的是 *http://eclipse.svnkit.com/1.7.x*，然后在 Eclipse 里安装                                                                                                                                                                                                                http://svnkit.com/download.phphttp://svnkit.com/download.php