...
h2. <a href="https://github.com/mojombo/jekyll/wiki/install">安装 Pygments</a> 

下面详细说明一下在 Windows 环境下安装 Pygments ~~ Linux 系统下的直接看教程就好了

h2. Step1

<a href="http://www.python.org/getit/">安装 Python 2.6 或以上版本</a>
...
在<a href="http://pygments.org/"> Pygments 官网</a>上传自己的代码或者使用现有的 demo 选择自己喜欢的样式，记下名称
...
<a href="http://pygments.org/docs/quickstart/"> >>>参考 pygments Command line usage </a>
...
* highlight 后面第一个参数为 language，如 python，也可以是 ruby 控制台 irb，更多 lanuages 可以查询 <a href="http://pygments.org/docs/lexers/">这里</a>～
* 第二个参数显示行号
