...
Windows-->Preferences-->Hadoop Map/Reduce，<b>Hadoop installation directory</b>: F:\workspace\hadoop-1.0.4

h2. Step3 build.xml

因为 Windows 无法在 cmd 中运行 shell 脚本（安装 cygwin 也没用），所以需要做一下注释
...
&lt;!-- 2.注释掉所有带&quot;autoreconf&quot;的&lt;exec&gt;标签，因为Windows下无法执行autoreconf命令（cygwin中安装了autoconf,automake,libtool也没用）&quot;--&gt;
...
# New_Builder-->Edit，<b>Name</b>(见名知意): hadoop-1.0.4_Builder，<b>Main-->Buildfile</b>(build.xml的位置): F:\workspace\release-1.0.4\build.xml，<b>Targets-->Manual Build: jar</b>
