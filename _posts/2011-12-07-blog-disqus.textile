...
<a href="http://disqus.com" target="_blank">注册 Disqus 帐号</a>，用邮箱注册下就可以了，注册需要填写：Site URL，Site Name，Site Shortname
...
安装，因为没有用到插件安装，所以选择最下面的 <a href="http://docs.disqus.com/developers/universal/" target="_blank">Universal Code</a> ～所谓安装，其实就是将一段 js 代码嵌入到你的博客源代码里面
...
<a href="http://disqus.com/api/docs/" target="_blank"> >>>The Disqus Web API</a>
...
<a href="http://disqus.rubyforge.org/classes/Disqus/Widget.html" target="_blank"> >>>Disqus Widget</a>